...
namespace InfoHubPhone8.Pages.Reader
{
    ...
    public class ReaderPageViewModel : SocialReaderViewModelBase<ReaderPageStates, ReaderAppBar>
    {
		        ...
		        public void Share()
        {
            ...
            shareLinkTask.Title = Activity.SocialActivity.Title;
            shareLinkTask.LinkUri = new Uri(Activity.SocialActivity.Url, UriKind.Absolute);
            shareLinkTask.Message = Activity.SocialActivity.Title;
